...
object WechatConstants {
    ...
    fun setVersion(version: String) {
        ...
        when (version) {
            ...
            "8.0.42" -> {//play version
                /* 微信聊天列表页控件 */
                RED_ENVELOPE_RECT_TITLE_ID = "com.tencent.mm:id/clh" //Item可点击控件id
                RED_ENVELOPE_TITLE_ID = "com.tencent.mm:id/i2_" //Item内容控件id，通过关键字判断
                /* 微信对话页控件 */
                RED_ENVELOPE_ID = "com.tencent.mm:id/bm5" //红包框可点击控件id
                RED_ENVELOPE_FLAG_ID = "com.tencent.mm:id/a4b" //红包框左下角'微信红包'控件id，等待
                RED_ENVELOPE_BEEN_GRAB_ID = "com.tencent.mm:id/a40" //红包框中间文字'已领取'控件id
                /* 红包弹框控件*/
                RED_ENVELOPE_OPEN_ID = "com.tencent.mm:id/jg7" //红包点开控件id
                RED_ENVELOPE_CLOSE_ID = "com.tencent.mm:id/jg6" //红包弹框关闭控件id
                /* 红包详情页控件 */
                RED_ENVELOPE_COUNT_ID = "com.tencent.mm:id/j9m" //红包金额id

                CHAT_EDITTEXT_ID = "com.tencent.mm:id/bm9" //聊天文本输入框id
                SEND_TEXT_ID = "com.tencent.mm:id/bsd" //发送按钮id
            }
            else -> { //8.0.31,8.0.32
                /* 微信聊天列表页控件 */
